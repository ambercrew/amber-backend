...
internal class AmberWebApplicationFactory : WebApplicationFactory<Program>, IDisposable
{
    ...
    protected override void ConfigureWebHost(IWebHostBuilder builder)
    {
        ...
        {
            services.RemoveAll<IDbContextOptionsConfiguration<AmberContext>>();
            ...
            services.AddDbContextPool<AmberContext>(options => options.UseSqlite(_connection));
        });
    }
